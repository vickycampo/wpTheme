...
class Setup
{
    ...
    public function setup()
    {
         ...
         */
        // load_theme_textdomain( 'awpstt', get_template_directory() . '/languages' );
        ...
        */
        ...
        add_theme_support( 'custom-background', apply_filters( 'awpstt_custom_background_args', array(
