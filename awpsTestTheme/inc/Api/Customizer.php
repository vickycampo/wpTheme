...
use awpstt\Api\Customizer\Sidebar;
use awpstt\Api\Customizer\Header;
use awpstt\Api\Customizer\Footer;
...
class Customizer 
{
	...
	public function output()
	{
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 'awpstt_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 'awpstt_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 'awpstt_header_background_color' );
			echo self::css( '.site-header', 'color', 'awpstt_header_text_color' );
			echo self::css( '.site-header a', 'color', 'awpstt_header_link_color' );
